// Envio de mensagem pelo humano — na Z-API não existe janela de 24h,
// então tudo é mensagem livre
import { db, sendText, sendTemplate, requireUser, saveMessage } from './_lib/core.js';
  ...
  try {
    if (useReopenTemplate) {
      ...
      await saveMessage(lead.id, {
        direction: 'out',
        sender: 'human',
        body: '[Automática] Mensagem de retomada enviada',
      });
