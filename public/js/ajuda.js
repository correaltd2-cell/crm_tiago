...
• FILTRO DE PROSPECÇÃO: em cima da lista tem os botões "Todos" e "Prospecção". Tocando em Prospecção, a rota mostra só os possíveis clientes daquele dia (o número da posição continua sendo o da rota inteira).
