...
3b. RETIRADA DE PEÇAS (CRÉDITO): quando o cliente tem peças antigas e NÃO vai comprar nada — só devolver — escolha o tipo "↩ Retirada de peças (crédito)" logo depois de escolher o cliente. Aí é só escolher cada produto e informar quantas unidades está recolhendo: o valor sai NEGATIVO e vira crédito do cliente. O recibo impresso sai como "Retirada de Mercadoria — Crédito do Cliente", com assinatura normal. No Financeiro, o crédito aparece como comissão negativa (abate do total do mês). Retirada não conta como compra do cliente.
