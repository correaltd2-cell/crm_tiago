...
• CLIENTE ATENDIDO VAI PARA O FIM: assim que a visita é registrada, o cartão fica cinza, encolhe e DESCE PARA O FIM DA LISTA. Quem ainda falta atender fica sempre no topo, e a rota mostra "Faltam X". O número da posição do cliente na rota não muda.
• ORGANIZAR POR PROXIMIDADE: o botão "ORGANIZAR POR PROXIMIDADE" reorganiza a rota do dia sozinho. Você escolhe quem é o CLIENTE Nº 1 (use ↑ ou "Primeiro"); a partir dele o sistema calcula a distância entre os endereços e enfileira os demais do mais perto para o mais longe, montando um caminho curto. Quem estiver sem localização no cadastro vai para o fim da lista. Funciona sem internet.
...
• FILTRO POR TIPO (primeira fila de botões): TODOS · SÓ CLIENTES · SÓ PROSPECÇÕES · PRIORITÁRIOS. Ele funciona junto com o filtro de cores: dá para ver, por exemplo, só as prospecções atrasadas.
...
Toda vez que o app abre, ele confere se ficou algum pedido dos ÚLTIMOS 30 DIAS sem ser marcado como faturado no New Star. Se ficou, aparece o aviso "⚠️ PEDIDO PENDENTE" listando os pedidos, com o valor, a data e um botão para marcar cada um como faturado ali mesmo. Dá para fechar o aviso, mas ele volta na próxima abertura enquanto houver pedido pendente — é justamente para não esquecer nenhum.
