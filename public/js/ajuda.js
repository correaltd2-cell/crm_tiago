...
6. Pronto: dá para VISUALIZAR O PDF do talão, COMPARTILHAR (WhatsApp/e-mail), IMPRIMIR (impressora do celular) e imprimir o CUPOM na mini impressora térmica de 58mm. Para a impressorinha térmica o caminho RECOMENDADO é o botão "🖨 IMPRIMIR 58MM (BLUETOOTH PRINT)": instale uma vez o aplicativo grátis "Bluetooth Print" (App Store/Play Store), conecte a impressora por Bluetooth dentro dele, e depois é só tocar no botão — o cupom sai direto, sem cortar. Se preferir outro app de impressora, use "🧾 Cupom 58mm (imagem)": gera o cupom como imagem e você compartilha com o app da impressora. A assinatura fica gravada para sempre no pedido.
