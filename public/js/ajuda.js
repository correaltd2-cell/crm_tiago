...
• CLASSE DO CLIENTE (A, B ou C): define a prioridade no reencaixe E o ritmo de visita — A = a cada 35 dias (prioridade máxima), B = a cada 60 dias (normal), C = a cada 90 dias (baixa: no reencaixe só entra se sobrar vaga depois dos A e B). Ao tocar em A, B ou C na ficha do cliente, o ciclo dele muda na hora e a próxima visita é recalculada. Os dias de rota trabalham com 6 visitas FIXAS e folga até 9 para reencaixes.
